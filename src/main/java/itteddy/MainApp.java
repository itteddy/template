...
public class MainApp {
    ...
    public static void main(String... args) throws Exception {
        ...
        // creating undertow server
        Undertow server = Undertow.builder()
                .addHttpListener(Integer.valueOf(8015), properties.getProperty("camelrest.host"))
                .setHandler(Handlers.resource(new ClassPathResourceManager(MainApp.class.getClassLoader()))
